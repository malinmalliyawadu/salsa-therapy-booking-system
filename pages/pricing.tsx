      ...
      <div className="max-w-full mx-auto my-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <PriceCard
            ...
            callToAction={
              <ButtonLink href="mailto:lily@salsatherapy.co.nz" className="block">
                ENQUIRE
              </ButtonLink>
            }
          />
        ...
        <div className="my-10 mx-6">
          ...
          <ul className="list-disc ml-6">
            <li>
              We do not offer refunds or partial refunds for unused passes unless injury or serious
              illness occur and students will need to present proof medical statements.
            </li>
            <li>Passes can be shared once only with a partner or best friend.</li>
            <li>Passes and memberships exclude special events.</li>
            <li>We can only pause membership during lockdowns and unforeseen circumstances.</li>
            <li>Student ID is to be presented at the reception for student deals.</li>
