    ...
    return (
        <div className="m-6">
            ...
            <Ul>
                ...
                <li>
                    <p>
                        ...
                        &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                        or &quot;Our&quot; in this Agreement) refers to Salsa
                        Therapy, 80 Cuba Street, Te Aro, Wellington 6011.
                    </p>
                </li>
                <li>
                    <p>
                ...
                <li>
                    <p>
                        <strong>Website</strong> refers to Salsa Therapy,
                        accessible from{' '}
                        <a
                            href="https://salsa-therapy-booking-system.web.app/"
                            rel="external nofollow noopener"
                            target="_blank"
                        >
                            https://salsa-therapy-booking-system.web.app/
                        </a>
                    </p>
                </li>
                <li>
            ...
            <Ul>
                <li>
                    By email:{' '}
                    <a href="mailto:lily@salsatherapy.co.nz">
                        lily@salsatherapy.co.nz
                    </a>
                </li>
                <li>
