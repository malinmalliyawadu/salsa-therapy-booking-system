...
const H2: React.FC = ({ children }) => {
  return <h2 className="font-bold text-4xl mb-2 tracking-tight">{children}</h2>;
};
const H3: React.FC = ({ children }) => {
  return <h3 className="font-bold text-2xl mb-2 tracking-tight">{children}</h3>;
};
...
const PrivacyPolicy: NextPage = () => {
  return (
    <div className="m-6">
      <h1 className="font-bold text-6xl mb-2 tracking-tight">Privacy Policy</h1>
      ...
      <Ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Salsa Therapy, 80 Cuba Street, Te Aro,
            Wellington 6011.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Salsa Therapy, accessible from{" "}
            <a
